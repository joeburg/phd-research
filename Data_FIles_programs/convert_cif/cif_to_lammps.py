    ...
    try:
        ...
        for line in f:
            ...
            if (cols[0] == '_cell_length_a'):
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_length_a'] = float(cols[1][:idx])
                else:
                ...
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_length_b'] = float(cols[1][:idx])
                else:
                ...
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_length_c'] = float(cols[1][:idx])
                else:
                ...
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_angle_alpha'] = float(cols[1][:idx])
                else:
                ...
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_angle_beta'] = float(cols[1][:idx])
                else:
                ...
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_angle_gamma'] = float(cols[1][:idx])
                else:
                ...
                idx = cols[1].find('(')
                if idx != -1:
                    data['_cell_volume'] = float(cols[1][:idx])
                else:
