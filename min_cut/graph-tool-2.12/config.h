...
#define CPPFLAGS " -I/usr/include/python3.5m -I/usr/include -I/usr/lib/python3.5/site-packages/numpy/core/include  -DSPARSEHASH_PREFIX=sparsehash"

/* c++ compilation options */
#define CXXFLAGS "-Wall -Wextra -ftemplate-backtrace-limit=0  -std=gnu++14 -DNDEBUG -ftemplate-depth-250 -Wno-deprecated -Wno-unknown-pragmas -O3 -fvisibility=default -fvisibility-inlines-hidden -Wno-unknown-pragmas  -DSPARSEHASH_PREFIX=sparsehash"
...
#define GIT_COMMIT "1d6bf978"

/* git HEAD commit date */
#define GIT_COMMIT_DATE "Fri Nov 6 15:54:18 2015 +0100"
...
/* linker options */
#define LDFLAGS " -L/usr/lib -lpython3.5m"
...
/* package source dir */
#define PACKAGE_SOURCE_DIR "/home/count0/stuff/workspace/releases/graph-tool-2.12"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "graph-tool 2.12"
...
/* The directory name for the site-packages subdirectory of the standard
   Python install tree. */
#define PYTHON_DIR "/usr/lib/python3.5/site-packages"
